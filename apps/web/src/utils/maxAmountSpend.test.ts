...
describe('maxAmountSpend', () => {
  ...
  it('should has value when CurrencyAmount is TOMO and CurrencyAmount is higher than min bnb', () => {
    expect(
      JSBI.greaterThan(
        maxAmountSpend(
  ...
  it('should be 0 when CurrencyAmount is TOMO and CurrencyAmount is low', () => {
    expect(
