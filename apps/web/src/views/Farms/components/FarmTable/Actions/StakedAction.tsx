...
const Staked: React.FunctionComponent<React.PropsWithChildren<StackedActionProps>> = ({
  ...
  const crossChainWarningText = useMemo(() => {
    return isFirstTime
      ? t('A small amount of %nativeToken% is required for the first-time setup of cross-chain ONEPIECE farming.', {
  ...
  const [onPresentDeposit] = useModal(
    <FarmUI.DepositModal
      ...
      showCrossChainFarmWarning={chainId !== ChainId.BASE && chainId !== ChainId.BSC_TESTNET}
