          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                ...
                <InlineLink href="https://docs.BaseDex.finance/tokenomics/cake/cake-tokenomics">
                  {t('CAKE Tokenomics')}
                </InlineLink>
              </Text>
            </li>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://docs.BaseDex.finance/products/lottery/lottery-guide">
              {t('how to play the BaseDex lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
