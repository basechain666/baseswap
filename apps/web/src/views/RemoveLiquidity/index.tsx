...
const zapSupportedChainId = [ChainId.BASE]
...
export default function RemoveLiquidity({ currencyA, currencyB, currencyIdA, currencyIdB }) {
  ...
  async function onRemove() {
    ...
    // we have a signature, use methodNames versions of remove liquidity
  ...
  const [onPresentRemoveLiquidity] = useModal(
    <ConfirmLiquidityModal
      ...
      cusBASEnDismiss={handleDismissConfirmation}
