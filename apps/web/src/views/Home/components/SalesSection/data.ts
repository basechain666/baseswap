...
export const earnSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t('OnePieceSwap makes it easy to make your crypto work for you.'),
  reverse: true,
  primaryButton: {
    to: '/farms',
    text: t('Explore'),
  ...
  secondaryButton: {
    to: 'https://docs.onepieceswap.finance/products/yield-farming',
    text: t('Learn'),
    external: true,
  },
  images: {
...
export const cakeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  secondaryButton: {
    to: 'https://docs.onepieceswap.finance/tokenomics/cake',
    text: t('Learn'),
    external: true,
  },
