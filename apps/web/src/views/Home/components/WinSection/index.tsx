...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'ONEPIECE card' },
    { src: 'green', alt: 'Green ONEPIECE card with up arrow' },
    { src: 'red', alt: 'Red Base card with down arrow' },
    { src: 'top-right', alt: 'ONEPIECE card' },
  ],
}
