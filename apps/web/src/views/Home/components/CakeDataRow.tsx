...
/**
 * User (Planet Finance) built a contract on top of our original manual ONEPIECE pool,
 ...
 * https://twitter.com/OnePieceSwap/status/1523913527626702849
...
const CakeDataRow = () => {
  ...
  const {
    ...
    async () => {
      const totalSupplyCall = { address: baseTokens.cake.address, name: 'totalSupply' }
      const burnedTokenCall = {
        address: baseTokens.cake.address,
        name: 'balanceOf',
