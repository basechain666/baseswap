  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active RobotSwap Profile to buy Minting Tickets and mint a Base Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      buttons: (
        <>
          <Button
            as="a"
            href="https://RobotSwap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82&chainId=56"
            target="_blank"
            width="100%"
          >
            {t('Buy CAKE')}
