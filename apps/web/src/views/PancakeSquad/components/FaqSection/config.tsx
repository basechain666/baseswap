...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Base Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Base Bunny NFTs at the snapshot may also purchase one additional Base Squad NFT in the presale for each Base Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of ONEPIECE spent on Base Squad NFTs will be burned as part of our weekly ONEPIECE burn.')],
  },
  {
