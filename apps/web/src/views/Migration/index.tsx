  ...
  const steps: Step[] = [
    {
      ...
      canHover: true,
      text: t('Unstake LP tokens and ONEPIECE from the old MasterChef contract.'),
    },
    {
      stepId: ProgressStepsType.STEP2,
      canHover: true,
      text: t('Stake LP tokens and ONEPIECE to the new MasterChef v2 contract.'),
    },
  ]
  ...
  return (
    <div ref={tableWrapperEl}>
      <PageHeader>
        ...
        <Link href="https://docs.OnePieceSwap.finance/code/migration/migrate-your-stakings" external>
