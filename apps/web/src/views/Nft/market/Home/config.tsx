  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WETH for BASE with no trading fees on BaseDex.'),
      ],
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.BaseDex.finance/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by BaseDex from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
