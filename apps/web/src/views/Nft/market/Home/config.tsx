  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WETH for BASE with no trading fees on RobotSwap.'),
      ],
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.RobotSwap.finance/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by RobotSwap from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
