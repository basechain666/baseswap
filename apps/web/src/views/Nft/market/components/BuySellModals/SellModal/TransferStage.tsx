import { Flex, Grid, Text, Button, Input, BASEIcon, ErrorIcon } from '@pancakeswap/uikit'
...
const TransferStage: React.FC<React.PropsWithChildren<TransferStageProps>> = ({
  ...
  const getErrorText = () => {
    if (isInvalidTransferAddress) {
      return t('That’s not a BASE Chain wallet address.')
    }
    ...
    <>
          ...
          {lowestPrice && (
            <>
              ...
              <Flex alignItems="center" justifyContent="flex-end">
                <BASEIcon width={16} height={16} mr="4px" />
      ...
      <GreyedOutContainer>
        ...
        <Input
          ...
          placeholder={t('Paste BASE address')}
