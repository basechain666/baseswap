...
import SettingsModal, { withCusBASEnDismiss } from 'components/Menu/GlobalSettings/SettingsModal'
...
const SettingsModalWithCustomDismiss = withCusBASEnDismiss(SettingsModal)
...
export default function StableSwapCommitButton({
  ...
  const [onPresentSettingsModal] = useModal(
    <SettingsModalWithCustomDismiss
      cusBASEnDismiss={() => setIndirectlyOpenConfirmModalState(true)}
  ...
  const [onPresentConfirmModal] = useModal(
    <ConfirmSwapModal
      ...
      cusBASEnDismiss={handleConfirmDismiss}
