...
const CHART_SUPPORT_CHAIN_IDS = [ChainId.BASE]
const ACCESS_TOKEN_SUPPORT_CHAIN_IDS = [ChainId.BASE]
const STABLE_SUPPORT_CHAIN_IDS = [ChainId.BSC_TESTNET, ChainId.BASE]
