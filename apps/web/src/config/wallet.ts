  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/dapp/baseswap.finance/',
      qrCode,
      downloadLink: 'https://metamask.app.link/dapp/baseswap.finance/',
    },
    {
      id: 'binance',
    ...
    },
    {
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://baseswap.finance/',
      downloadLink: {
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://docs.baseswap.finance/v/${docLangCodeMapping[code]}/get-started/connection-guide`
    : `https://docs.baseswap.finance/get-started/connection-guide`
