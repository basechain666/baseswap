...
export const API_PROFILE = 'https://profile.baseswap.com'
export const API_NFT = 'https://nft.baseswap.com/api/v1'
...
export const ACCESS_RISK_API = 'https://red.alert.baseswap.com/red-api'
