...
export const API_PROFILE = 'https://profile.onepieceswap.com'
export const API_NFT = 'https://nft.onepieceswap.com/api/v1'
...
export const FARM_API = 'https://farms.base-swap.workers.dev'

export const BIT_QUERY = 'https://graphql.bitquery.io'

export const ACCESS_RISK_API = 'https://red.alert.onepieceswap.com/red-api'

export const CELER_API = 'https://api.celerscan.com/scan'

export const INFO_CLIENT_WITH_CHAIN = {
  [ChainId.BASE]: 'https://bsc.streamingfast.io/subgraphs/name/pancakeswap/exchange-v2',
  [ChainId.ETHEREUM]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/exhange-eth',
}

export const BLOCKS_CLIENT_WITH_CHAIN = {
  [ChainId.BASE]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/blocks',
