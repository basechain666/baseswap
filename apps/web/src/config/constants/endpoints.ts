...
export const API_PROFILE = 'https://profile.robotswap.com'
export const API_NFT = 'https://nft.robotswap.com/api/v1'
...
export const ACCESS_RISK_API = 'https://red.alert.robotswap.com/red-api'
