...
import { baseTokens, bscTestnetTokens, USDC, USDT, BUSD, WBTC_ETH } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.BASE]: '0xD3C1B2284FbC1F4F22d4C4C77De0a74A546150F4',
 ...
 * tokens.
 * @example [AMPL.address]: [DAI, WNATIVE[ChainId.BASE]]
 */
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BASE]: [baseTokens.onepiece],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.weth, bscTestnetTokens.cake, bscTestnetTokens.busd],
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.RINKEBY]: [USDC[ChainId.RINKEBY], WNATIVE[ChainId.RINKEBY], BUSD[ChainId.RINKEBY]],
  [ChainId.GOERLI]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
  [ChainId.BASE]: [baseTokens.onepiece, baseTokens.eth],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.weth, bscTestnetTokens.cake, bscTestnetTokens.busd],
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.BASE]: [
    [baseTokens.onepiece, baseTokens.eth],
  ],
}
...
// used to ensure the user doesn't send so much BASE so they end up with <.01
export const MIN_BNB: JSBI = JSBI.exponentiate(BIG_INT_TEN, JSBI.BigInt(16)) // .01 BASE
...
// BASE
export const DEFAULT_INPUT_CURRENCY = 'BASE'
// ONEPIECE
export const DEFAULT_OUTPUT_CURRENCY = '0xBA78d493f42e63ABd27853FA1e7FD5060A351fA3'

// Handler string is passed to Gelato to use PCS router
export const GELATO_HANDLER = 'pancakeswap'
export const GENERIC_GAS_LIMIT_ORDER_EXECUTION = BigNumber.from(500000)

export const LIMIT_ORDERS_DOCS_URL = 'https://docs.onepieceswap.finance/products/pancakeswap-exchange/limit-orders'
