...
// import { tmcTokens } from '@pancakeswap/tokens'
...
describe('Trade', () => {
  ...
  //         [PairState.EXISTS, new Pair(new TokenAmount(tmcTokens.wbnb, '1'), new TokenAmount(tmcTokens.cake, '1'))],
  //         [PairState.INVALID, new Pair(new TokenAmount(tmcTokens.busd, '1'), new TokenAmount(tmcTokens.cake, '1'))],
  //         [PairState.LOADING, new Pair(new TokenAmount(tmcTokens.busd, '1'), new TokenAmount(tmcTokens.wbnb, '1'))],
  //         [PairState.EXISTS, null],
  //       ])
  //       const { result } = renderHook(() => {
  //         const pairs = Trades.useAllCommonPairs(tmcTokens.wbnb, tmcTokens.cake)
  //         return {
  //           pairs,
  //         }
  //       })
  //       expect(result.current.pairs).toStrictEqual([
  //         new Pair(new TokenAmount(tmcTokens.wbnb, '1'), new TokenAmount(tmcTokens.cake, '1')),
  //       ])
  //     })
  ...
  //         [PairState.EXISTS, new Pair(new TokenAmount(tmcTokens.wbnb, '1'), new TokenAmount(tmcTokens.cake, '1'))],
  //         [PairState.EXISTS, new Pair(new TokenAmount(tmcTokens.wbnb, '1'), new TokenAmount(tmcTokens.cake, '1'))],
  //         [PairState.EXISTS, new Pair(new TokenAmount(tmcTokens.cake, '1'), new TokenAmount(tmcTokens.wbnb, '1'))],
  //         [PairState.EXISTS, null],
  //       ])
  //       const { result } = renderHook(() => {
  //         const pairs = Trades.useAllCommonPairs(tmcTokens.wbnb, tmcTokens.cake)
  ...
  //       renderHook(() => {
  //         Trades.useAllCommonPairs(tmcTokens.wbnb, tmcTokens.cake)
  //       })
  ...
  //       mockUsePairs.mockClear()
  //       renderHook(() => {
  //         Trades.useAllCommonPairs(tmcTokens.wbnb, tmcTokens.wbnb)
  //       })
  //       expect(mockUsePairs).toMatchSnapshot()
  //     })
  //   })
  ...
  //       const allowPairs = [new Pair(new TokenAmount(tmcTokens.wbnb, '1'), new TokenAmount(tmcTokens.cake, '1'))]
  //       const argA = CurrencyAmount.ether('1000000')
  //       const argB = tmcTokens.cake
  //       renderHook(
  //         () => {
