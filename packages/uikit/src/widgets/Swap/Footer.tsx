...
> = ({
  variant = "default",
  helpUrl,
  helpImage = <Image src="https://cdn.RobotSwap.com/help/help.png" alt="Get some help" width={160} height={108} />,
  isEvm = true,
}) => {
        ...
        {/* {isEvm ? (
          <>
            <ButtonMenu variant="subtle" scale="sm" activeIndex={0}>
              ...
              <ButtonMenuItem as="a" href="https://v1exchange.RobotSwap.finance/#/">
                {t("V1 (old)")}
              </ButtonMenuItem>
            </ButtonMenu>
            <LinkExternal
