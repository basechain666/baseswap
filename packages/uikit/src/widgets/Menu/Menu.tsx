...
const Menu: React.FC<React.PropsWithChildren<NavProps>> = ({
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const isBotBASEfPage = window.document.body.clientHeight === currentOffset + window.innerHeight;
      ...
      >
        <Wrapper>
          ...
          <BodyWrapper mt={!subLinks ? `${totalTopMenuHeight + 1}px` : "0"}>
            ...
            <StyledSocialLinks order={[2]} pb={["42px", null, "32px"]} mb={["10px", null, "10px"]} style={{ position: "absolute" , bottom: "0px", left: "50%", transform: "translateX(-50%)"}} />
          </BodyWrapper>
        </Wrapper>
      </AtomBox>
      {/* <Footer
