...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c6:hover:not(:disabled):not(.tomo-button--disabled):not(.tomo-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c6:active:not(:disabled):not(.tomo-button--disabled):not(.tomo-button--disabled) {
      opacity: 0.85;
