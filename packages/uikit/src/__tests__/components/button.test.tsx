...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c0:hover:not(:disabled):not(.tomo-button--disabled):not(.tomo-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c0:active:not(:disabled):not(.tomo-button--disabled):not(.tomo-button--disabled) {
      opacity: 0.85;
