...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c1:hover:not(:disabled):not(.tomo-button--disabled):not(.tomo-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c1:active:not(:disabled):not(.tomo-button--disabled):not(.tomo-button--disabled) {
      opacity: 0.85;
