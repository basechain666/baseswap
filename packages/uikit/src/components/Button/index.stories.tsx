...
export const Anchors: React.FC<React.PropsWithChildren> = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://BaseSwap.finance" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://BaseSwap.finance" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
