...
export const Anchors: React.FC<React.PropsWithChildren> = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://BaseDex.finance" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://BaseDex.finance" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
